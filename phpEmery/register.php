...
media="screen">
 ...
 (substr_count($_POST['email'], '@') !=1) ) {
  ...
  if (!$problem) { // if no problems...
    ...
    mail($_POST['email'], 'Registration Confirmation', $body, 'From: codeypacker@gmail.com');
  ...
  <form action="register.php" method="post">
    <p>First Name: <input type="text" name="first_name" size="20" value="<?php if (isset($_POST['first_name'])) {
      print htmlspecialchars($_POST['first_name']);
    }?>"></p>

    <p>Last Name: <input type="text" name="last_name" size="20" value="<?php if (isset($_POST['last_name'])) {
    ...
    <p>Email Address: <input type="text" name="email" size="20" value="<?php if (isset($_POST['email'])) {
      ...
      <p>Password: <input type="password" name="password1" size="20" value="<?php if (isset($_POST['password'])) {
